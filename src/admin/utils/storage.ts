...
const defaultAbout: AboutInfo = {
  historyParagraphs: [
    'Azariel Senior Secondary School is a public school proudly serving learners at Lukholweni Location, Matatiele, in the Alfred Nzo West District of the Eastern Cape.',
    'Located within the Nunge Circuit under CMC Matatiele, Azariel SSS is committed to academic excellence, disciplined learning, and community values. Our motto — "Soar Like an Eagle" — reflects the spirit of every learner who walks through our doors.',
  ...
  principalMessage: [
    ...
    'We value respect, responsibility, and pride in our school community. Hard work pays, and at Azariel SSS, we are committed to proving that amidst every difficulty, we rise.',
  ],
};
