...
export const Footer = () => {
  return (
    <footer className="pt-12 pb-8 w-full" style={ { background: '#0D3F6E', borderTop: '4px solid #4EA8DE' } }>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 mb-10">
          ...
          <div className="sm:col-span-2 lg:col-span-1">
            <div className="flex items-center gap-3 mb-3">
              <div className="h-12 w-12 shrink-0 rounded-xl overflow-hidden shadow-lg"
                ...
                <img src="/assets/logo/azariel-logo.png" alt="Azariel SSS logo"
              ...
              <div>
                ...
                <p className="text-sm italic mt-0.5" style={ { color: 'rgba(78,168,222,0.65)' } }>
                  "Soar Like an Eagle"
                </p>
              </div>
            </div>
            ...
            <div className="flex gap-3 mt-4">
              <a href="https://www.facebook.com/azarielsss/" target="_blank" rel="noreferrer"
                className="p-2 rounded-full transition-colors"
                style={ { background: 'rgba(78,168,222,0.15)', color: '#4EA8DE' } }
                aria-label="Facebook">
                <Facebook size={18} />
              </a>
            </div>
          ...
          <div>
            <h4 className="text-sm font-bold mb-4 pb-2 uppercase tracking-wide"
              style={ { color: '#4EA8DE', borderBottom: '1px solid rgba(78,168,222,0.25)' } }>
              Contact Us
            </h4>
            <ul className="space-y-3 text-sm" style={ { color: 'rgba(78,168,222,0.8)' } }>
              <li className="flex items-start gap-2">
                <MapPin className="shrink-0 mt-0.5" size={16} />
                <span>Matatiele, Eastern Cape, 4730</span>
              </li>
              <li className="flex items-center gap-2">
                <Phone size={16} className="shrink-0" />
                <span>Alfred Nzo West Education District</span>
              </li>
              <li className="flex items-start gap-2">
                <Mail size={16} className="shrink-0 mt-0.5" />
                <span className="break-all">info@azarielsss.edu.za</span>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm" style={ { color: 'rgba(78,168,222,0.8)' } }>
        ...
        {/* Bottom bar */}
        <div className="pt-6 text-center text-xs" style={ { borderTop: '1px solid rgba(78,168,222,0.15)', color: 'rgba(78,168,222,0.5)' } }>
          <p>© {new Date().getFullYear()} Azariel Senior Secondary School. All Rights Reserved.</p>
          <Link to="/admin/login"
            className="text-xs mt-2 inline-block transition-colors hover:opacity-80"
            style={ { color: 'rgba(78,168,222,0.3)' } }>
            Staff Portal
          </Link>
        </div>
