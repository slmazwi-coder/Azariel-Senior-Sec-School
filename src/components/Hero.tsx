...
const slides = [
  { url: '/assets/hero/FB_IMG_1780916120382.jpg', caption: 'Academic Excellence' },
  { url: '/assets/hero/FB_IMG_1780916126763.jpg', caption: 'Soar Like an Eagle' },
  { url: '/assets/hero/FB_IMG_1780916132306.jpg', caption: 'Our Proud Learners' },
];
...
export const Hero = () => {
  ...
  return (
    <div className="relative h-[650px] w-full overflow-hidden" style={ { background: '#0D3F6E' } }>
      <AnimatePresence mode="wait">
        ...
        >
          ...
          <div className="absolute inset-0"
            style={ { background: 'linear-gradient(to top, rgba(13,63,110,0.92) 0%, rgba(31,111,165,0.55) 45%, rgba(78,168,222,0.35) 100%)' } } />
        </motion.div>
      </AnimatePresence>
      ...
      <div className="absolute inset-0 flex flex-col items-center justify-center text-center px-4 z-10">
        ...
        >
          <a href="/admissions"
            ...
            style={ { background: '#C9A227', color: '#0D3F6E' } }
          >
            Apply Now
          </a>
          <a href="/about"
            className="px-7 py-3 font-bold transition-all rounded-lg hover:-translate-y-0.5"
            style={ { border: '2px solid #C9A227', color: '#C9A227', background: 'transparent' } }
          >
            About Us
          </a>
        </motion.div>
      ...
      <div className="absolute bottom-8 left-1/2 -translate-x-1/2 flex gap-2 z-30 flex-wrap justify-center max-w-xs">
        {slides.map((_, i) => (
          <button
            ...
            style={ { background: i === currentIndex ? '#C9A227' : 'rgba(201,162,39,0.3)' } }
          />
        ))}
      </div>
    </div>
