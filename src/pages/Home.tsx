      ...
      <section className="py-10 sm:py-12 bg-white">
        <div className="mx-auto max-w-7xl w-full px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
            <div className="rounded-3xl border border-[#4EA8DE] bg-[#FDF9EC] p-6 sm:p-7 flex gap-4 items-start">
            ...
            <div className="rounded-3xl border border-gray-200 bg-gray-50 p-6 sm:p-7 flex gap-4 items-start">
              ...
              <div className="min-w-0">
                <div className="flex flex-wrap items-center gap-2">
                  <div className="text-sm font-black uppercase tracking-widest text-[#0D3F6E]">Boarding</div>
                ...
                <a href="/boarding" className="mt-4 inline-flex items-center gap-2 text-[#0D3F6E] font-bold">
      ...
      <section className="py-12 bg-gray-50 -mt-4 mx-auto max-w-7xl w-full px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {stats.map((stat, i) => (
            ...
            >
              <div className="p-4 bg-[#FDF9EC] rounded-xl text-[#0D3F6E]">
                <stat.icon size={32} />
              </div>
              <div>
